...
public class Game : Node
{
    ...
    public void SaveNodes()
    {
        ...
        //saveGame.OpenEncryptedWithPass("user://game.dat", (int)File.ModeFlags.Write, "nullistruenullisgood");
    ...
    // public Dictionary<string, object> LoadNodes()
    // {
    //     var loadGame = new File();
    //     Dictionary<string, object> loadNodes = new Dictionary<string, object>();

    //     if (loadGame.FileExists("user://game.dat"))
    //     {
    //         loadGame.Open("user://game.dat", (int)File.ModeFlags.Read);
    //         var saveNodes = GetTree().GetNodesInGroup("Persist");

    //         foreach (Node saveNode in saveNodes)
    //         {
    //             var currentLine = loadGame.GetLine();
    //             if (currentLine.Contains(saveNode.GetPath()))
    //             {
    //                 var nodeData = JSON.Parse(loadGame.GetLine());
    //                 loadNodes.Add(saveNode.GetPath(), nodeData);
    //             }
    //         }
    //         loadGame.Close();
    ...
    public Dictionary<string, object> GetSaveDictionary(Node saveNode){
        var saveDictionary = new Dictionary<string, object>();
        var saveNodes = GetTree().GetNodesInGroup("Persist");
    ...
    // public Dictionary GetSaveDictionary(Node saveNode){
    ...
    // public Dictionary Save(Game game)
    // {
